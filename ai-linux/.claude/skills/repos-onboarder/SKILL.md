...
description: |
  初見のリポジトリを外側から内側へ対話的に解説し、MarkdownまたはHTMLのオンボーディング文書を段階的に作成する。コードベースの全体像、キャッチアップ、引き継ぎ、入門資料を求められた時に使用する。現在のセッション内容の理解確認はsession-teacher、技術自体の調査はtech-researcherを優先する。
